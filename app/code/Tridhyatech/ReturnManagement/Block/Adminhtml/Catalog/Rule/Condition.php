...
namespace Tridhyatech\ReturnManagement\Block\Adminhtml\Catalog\Rule;
...
class Condition extends Generic implements TabInterface
{
    ...
    public function __construct(
        ...
        $this->CustomConditionFactory = $RuleFactory;
    ...
    private function getRuleFactory()
    {
        if ($this->ruleFactory === null) {
            $this->ruleFactory = ObjectManager::getInstance()->get('Tridhyatech\ReturnManagement\Model\RuleFactory');
        }
